"""UA Offer Generator – standalone Streamlit application.

This build embeds the core logic in the main Streamlit file so that deployment
does not depend on a separate offer_core.py file.
"""
